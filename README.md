...
_Замечание:_ при проверки задание пожалуйста читайте .pdf-файл, так как некоторые метод выводят различные показатели и за чего файл .ipyhnb невозможно читать
___
