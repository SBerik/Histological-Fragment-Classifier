...
_Замечание:_ при проверки задание через github, пожалуйста читайте .pdf-файл. Так как некоторые методы выводят показатели loss и accuracy вследствие, чего файл .ipyhnb через github невозможно читать. 
___
